...
This project presents a framework for monitoring and predicting the behavior of dynamic industrial systems by combining:

- Hidden Markov Models (HMM) for regime detection  
- Bayesian Adaptive Fault Observer (BAFO) for degradation estimation  
- Monte Carlo simulation for probabilistic risk projection  
...
```bash
git clone https://github.com/your-username/bafo-framework.git
cd bafo-framework
```
